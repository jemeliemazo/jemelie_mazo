...
<body class="min-h-screen flex items-center justify-center py-8">
  ...
  <div class="text-center mb-8">
    <h1 class="text-3xl font-bold text-pink-600 mb-4">🌸 Update Cute User 🌸</h1>
  ...
  <div class="bubble cute-shadow p-8 w-full max-w-md animate-bounceIn">
    <h2 class="text-2xl font-bold text-center text-purple-600 mb-6">📝 Update Record</h2>
